    ...
    async def _setup_team_agent(self) -> None:  
        ...
        try:  
            ...
            analysis_planning_agent = AssistantAgent(  
                ...
                description="The orchestrator agent. Receives user's abstract request, breaks it down into clear subtasks, delegates them to specialists, integrates their outputs, and synthesizes the final answer.",  
