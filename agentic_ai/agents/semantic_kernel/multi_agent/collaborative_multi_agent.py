...
class Agent(BaseAgent):
    ...
    async def _setup_team(self) -> None:
        ...
        self.provizio_plugin = MCPSsePlugin(
            name="ProvizioMCP",
            description="Provizio MCP Plugin",
            url=self.mcp_server_uri,
            headers={"Content-Type": "application/json"},
            timeout=30,
        )
        await self.provizio_plugin.connect()
        ...
        specialist_kernel.add_plugin(self.provizio_plugin, plugin_name="ProvizioMCP")
        ...
        crm_billing = make_agent(
            ...
            included_tools=[
                "ProvizioMCP-get_all_customers",
                "ProvizioMCP-get_customer_detail",
                "ProvizioMCP-get_subscription_detail",
                "ProvizioMCP-get_invoice_payments",
                "ProvizioMCP-pay_invoice",
                "ProvizioMCP-get_data_usage",
                "ProvizioMCP-search_knowledge_base",
                "ProvizioMCP-get_customer_orders",
                "ProvizioMCP-update_subscription",
                "ProvizioMCP-get_billing_summary",
            ],
        )
        ...
        product_promotions = make_agent(
            ...
            included_tools=[
                "ProvizioMCP-get_all_customers",
                "ProvizioMCP-get_customer_detail",
                "ProvizioMCP-get_promotions",
                "ProvizioMCP-get_eligible_promotions",
                "ProvizioMCP-search_knowledge_base",
                "ProvizioMCP-get_products",
                "ProvizioMCP-get_product_detail",
            ],
        )
        ...
        security_authentication = make_agent(
            ...
            included_tools=[
                "ProvizioMCP-get_all_customers",
                "ProvizioMCP-get_customer_detail",
                "ProvizioMCP-get_security_logs",
                "ProvizioMCP-search_knowledge_base",
                "ProvizioMCP-unlock_account",
            ],
        )
...
if __name__ == "__main__":
    ...
    async def _demo() -> None:
        ...
        print("\n>>> Assistant reply:\n", answer)
        try:
            await agent.provizio_plugin.close()
        except Exception as exc:
